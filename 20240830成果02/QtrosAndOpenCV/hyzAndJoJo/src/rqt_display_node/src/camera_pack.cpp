...
private:
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg)
    {
        ...
        //     RCLCPP_DEBUG(this->get_logger(), "jr  excep");
        //     cv_ptr = cv_bridge::toCvCopy(msg, sensor_msgs::image_encodings::BGR8);
        //     RCLCPP_DEBUG(this->get_logger(), "cg  excep");
        // }
        ...
        //                                                     std_msgs::msg::Header(), sensor_msgs::image_encodings::YUV422, processed_image).toImageMsg();
        // RCLCPP_DEBUG(this->get_logger(), "fb  excep");
        // // 发布处理后的图像
        // image_publisher_->publish(*output_msg);
        // RCLCPP_DEBUG(this->get_logger(), "fbcg  excep");
    }
